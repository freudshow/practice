...
typedef struct {
       rptInfo_s rptList[MAXNUM_AUTOTASK][2];//rptList[i][0].sign
} taskFailInfo_s;
...
typedef enum {
	...
	ZB_INFO_GET = 6,			//补遗7增加：宽带增补协议测试流程，查询模块网络拓扑信息，多网络信息，宽带载波通讯参数等
	ZB_NET_INFO_GET = 7,		//网络拓扑信息
//	ECHO_MASTER_HPLCF209_9 = 7,	//应答主站招测F209 属性9
}gdm_type;
