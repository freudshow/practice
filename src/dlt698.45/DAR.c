...
static asn_INTEGER_enum_map_t asn_MAP_DAR_value2enum_1[] = {
	{ -255,	5,	"other" },
	{ 0,	3,	"suc" },
	{ 1,	11,	"hardInvalid" },
...
static unsigned int asn_MAP_DAR_enum2value_1[] = {
	28,	/* addrException(27) */
...
static asn_INTEGER_specifics_t asn_SPC_DAR_specs_1 = {
...
static ber_tlv_tag_t asn_DEF_DAR_tags_1[] = {
