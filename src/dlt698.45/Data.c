...
static ber_tlv_tag_t asn_DEF_structure_tags_5[] = {
...
static asn_TYPE_member_t asn_MBR_Data_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct Data, choice.dateTimeBCD),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct Data, choice.dateTimeBCDH),
		(ASN_TAG_CLASS_CONTEXT | (29 << 2)),
		+1,	/* EXPLICIT tag at current level */
		&asn_DEF_DateTimeBCDH,
		0,	/* Defer constraints checking to the member type */
		0,	/* PER is not compiled, use -gen-PER */
		0,
		"dateTimeBCDH"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct Data, choice.datetimeBCDS),
		(ASN_TAG_CLASS_CONTEXT | (30 << 2)),
		+1,	/* EXPLICIT tag at current level */
		&asn_DEF_DateTimeBCDS,
		0,	/* Defer constraints checking to the member type */
		0,	/* PER is not compiled, use -gen-PER */
		0,
		"datetimeBCDS"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct Data, choice.dateBCD),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct Data, choice.timeBCD),
...
static asn_TYPE_tag2member_t asn_MAP_Data_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (28 << 2)), 22, 0, 0 }, /* dateTimeBCD */
    { (ASN_TAG_CLASS_CONTEXT | (29 << 2)), 23, 0, 0 }, /* dateTimeBCDH */
    { (ASN_TAG_CLASS_CONTEXT | (30 << 2)), 24, 0, 0 }, /* datetimeBCDS */
    { (ASN_TAG_CLASS_CONTEXT | (31 << 2)), 25, 0, 0 }, /* dateBCD */
    { (ASN_TAG_CLASS_CONTEXT | (32 << 2)), 26, 0, 0 }, /* timeBCD */
    { (ASN_TAG_CLASS_CONTEXT | (80 << 2)), 27, 0, 0 }, /* oi */
    { (ASN_TAG_CLASS_CONTEXT | (81 << 2)), 28, 0, 0 }, /* oad */
    { (ASN_TAG_CLASS_CONTEXT | (82 << 2)), 29, 0, 0 }, /* road */
    { (ASN_TAG_CLASS_CONTEXT | (83 << 2)), 30, 0, 0 }, /* omd */
    { (ASN_TAG_CLASS_CONTEXT | (84 << 2)), 31, 0, 0 }, /* ti */
    { (ASN_TAG_CLASS_CONTEXT | (85 << 2)), 32, 0, 0 }, /* tsa */
    { (ASN_TAG_CLASS_CONTEXT | (86 << 2)), 33, 0, 0 }, /* mac */
    { (ASN_TAG_CLASS_CONTEXT | (87 << 2)), 34, 0, 0 }, /* rn */
    { (ASN_TAG_CLASS_CONTEXT | (88 << 2)), 35, 0, 0 }, /* region */
    { (ASN_TAG_CLASS_CONTEXT | (89 << 2)), 36, 0, 0 }, /* scalerUnit */
    { (ASN_TAG_CLASS_CONTEXT | (90 << 2)), 37, 0, 0 }, /* rsd */
    { (ASN_TAG_CLASS_CONTEXT | (91 << 2)), 38, 0, 0 }, /* csd */
    { (ASN_TAG_CLASS_CONTEXT | (92 << 2)), 39, 0, 0 }, /* ms */
    { (ASN_TAG_CLASS_CONTEXT | (93 << 2)), 40, 0, 0 }, /* sid */
    { (ASN_TAG_CLASS_CONTEXT | (94 << 2)), 41, 0, 0 }, /* sidMac */
    { (ASN_TAG_CLASS_CONTEXT | (95 << 2)), 42, 0, 0 }, /* comdcb */
    { (ASN_TAG_CLASS_CONTEXT | (96 << 2)), 43, 0, 0 } /* rcsd */
};
