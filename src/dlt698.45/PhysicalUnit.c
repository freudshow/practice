...
static asn_INTEGER_enum_map_t asn_MAP_PhysicalUnit_value2enum_1[] = {
	{ 1,	1,	"a" },
	{ 2,	2,	"mo" },
	{ 3,	2,	"wk" },
	{ 4,	1,	"d" },
...
static unsigned int asn_MAP_PhysicalUnit_enum2value_1[] = {
	0,	/* a(1) */
	9,	/* currency(10) */
	3,	/* d(4) */
	4,	/* h(5) */
...
static asn_INTEGER_specifics_t asn_SPC_PhysicalUnit_specs_1 = {
...
static ber_tlv_tag_t asn_DEF_PhysicalUnit_tags_1[] = {
