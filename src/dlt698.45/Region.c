...
static asn_INTEGER_enum_map_t asn_MAP_regionUnit_value2enum_2[] = {
	{ 0,	9,	"closeOpen" },
	{ 1,	9,	"openClose" },
	{ 2,	10,	"closeClose" },
	{ 3,	8,	"openOpen" }
};
static unsigned int asn_MAP_regionUnit_enum2value_2[] = {
	2,	/* closeClose(2) */
	0,	/* closeOpen(0) */
	1,	/* openClose(1) */
	3	/* openOpen(3) */
};
static asn_INTEGER_specifics_t asn_SPC_regionUnit_specs_2 = {
...
static ber_tlv_tag_t asn_DEF_regionUnit_tags_2[] = {
...
static ber_tlv_tag_t asn_DEF_Region_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_Region_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (28 << 2)), 1, 0, 1 }, /* dateTimeBCD */
    { (ASN_TAG_CLASS_CONTEXT | (28 << 2)), 2, -1, 0 }, /* dateTimeBCD */
    { (ASN_TAG_CLASS_CONTEXT | (29 << 2)), 1, 0, 1 }, /* dateTimeBCDH */
    { (ASN_TAG_CLASS_CONTEXT | (29 << 2)), 2, -1, 0 }, /* dateTimeBCDH */
    { (ASN_TAG_CLASS_CONTEXT | (30 << 2)), 1, 0, 1 }, /* datetimeBCDS */
    { (ASN_TAG_CLASS_CONTEXT | (30 << 2)), 2, -1, 0 }, /* datetimeBCDS */
    { (ASN_TAG_CLASS_CONTEXT | (31 << 2)), 1, 0, 1 }, /* dateBCD */
    { (ASN_TAG_CLASS_CONTEXT | (31 << 2)), 2, -1, 0 }, /* dateBCD */
    { (ASN_TAG_CLASS_CONTEXT | (32 << 2)), 1, 0, 1 }, /* timeBCD */
    { (ASN_TAG_CLASS_CONTEXT | (32 << 2)), 2, -1, 0 }, /* timeBCD */
